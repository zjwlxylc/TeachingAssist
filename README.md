...
本仓库当前已完成“阶段 1：项目基础框架搭建”“阶段 2：系统管理与部署基础”“阶段 3：课程、班级、课堂与学生导入”和“阶段 4：课堂状态机与签到系统”，提供可运行的 FastAPI 后端、React/Vite 前端、SQLite 初始化与迁移、教师认证、网卡端口检测、防火墙引导、数据库备份恢复基础能力、课前准备、学生名单导入、课堂开始/结束和学生签到能力。
